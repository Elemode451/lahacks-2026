...
import typicalPaths from "../../imports/TypicalInterface/svg-syb5hmyv5i";
  ...
  return (
    <svg fill="none" preserveAspectRatio="none" viewBox="0 0 242.147 40.576" {...props}>
      <g id="seratune">
        ...
        <path d={typicalPaths.pa3ccd00} fill="var(--fill-0, #0D3B66)" id="Vector_4" />
        <path d={typicalPaths.p27c4ff00} fill="var(--fill-0, #0D3B66)" id="Vector_5" />
        <path d={typicalPaths.p1b04ee00} fill="var(--fill-0, #0D3B66)" id="Vector_6" />
        <path d={typicalPaths.p8179a80} fill="var(--fill-0, #0D3B66)" id="Vector_7" />
        <path d={typicalPaths.p32890580} fill="var(--fill-0, #0D3B66)" id="Vector_8" />
...
export function SpiderChartSvg(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" preserveAspectRatio="none" viewBox="0 0 408 408" {...props}>
      <g id="spider chart">
        <path d={typicalPaths.p727db00} fill="var(--fill-0, #0D3B66)" id="background" />
        <path d={typicalPaths.pf291900} id="values" stroke="var(--stroke-0, #F95738)" strokeWidth="4" />
      </g>
    </svg>
  );
}
